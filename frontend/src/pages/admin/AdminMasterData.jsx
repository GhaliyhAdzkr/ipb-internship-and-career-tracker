        ...
        <div className="font-jakarta space-y-8 pb-32">
            ...
            <div className="bg-sky-950 py-8 px-5 sm:py-12 sm:px-10 rounded-[1.5rem] sm:rounded-[2.5rem] text-white shadow-xl relative overflow-hidden">
                <div className="relative z-10 flex flex-col md:flex-row justify-between md:items-center gap-6">
                    <div>
                        <h1 className="text-2xl sm:text-3xl font-extrabold mb-2 tracking-tight">Parameter Program Studi</h1>
                    ...
                    <button 
                        ...
                        className="w-full md:w-auto bg-white text-sky-950 px-8 py-4 rounded-2xl font-extrabold flex items-center justify-center gap-2 hover:bg-sky-50 transition-all shadow-xl shadow-sky-900/30 active:scale-95 animate-pulse-subtle"
                    >
                        <PiPlusBold size={20} />
                        Tambah Prodi
                    </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {isLoadingDepartments ? (
                    <div className="lg:col-span-3 p-12 sm:p-32 text-center text-slate-400 bg-white rounded-[1.5rem] sm:rounded-[2.5rem] border border-dashed border-slate-200">
                    ...
                    filteredData.map((item) => (
                        <div key={item.id} className="bg-white p-5 sm:p-7 rounded-[1.5rem] sm:rounded-[2.5rem] shadow-sm border border-slate-100 hover:shadow-xl hover:border-sky-100 transition-all group flex flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="lg:col-span-3 p-12 sm:p-32 text-center text-slate-400 bg-white rounded-[1.5rem] sm:rounded-[2.5rem] border border-dashed border-slate-200 italic font-medium">
            ...
            {isFormOpen && (
                <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-0 sm:p-4">
                    ...
                    <div className="relative bg-white rounded-t-[2rem] sm:rounded-[2.5rem] shadow-2xl w-full max-w-lg max-h-[92dvh] overflow-y-auto animate-in slide-in-from-bottom-10 duration-300 overflow-hidden">
