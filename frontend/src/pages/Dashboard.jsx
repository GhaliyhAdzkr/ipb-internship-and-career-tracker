					...
					<div className="grid grid-cols-3  m-5 gap-5">
						<div>
							<div className="flex justify-between items-center py-3 font-jakarta font-bold">
								...
								<NavLink to="/lamaran" className="cursor-default text-sm text-sky-950 hover:text-sky-800">
									Selengkapnya
								</NavLink>
							</div>
						...
						<div className="col-span-2">
							<div className="flex justify-between items-center py-3 font-jakarta font-bold">
								...
								<NavLink to="/lowongan" className="cursor-default text-sm text-sky-950 hover:text-sky-800">
									Selengkapnya
								</NavLink>
							</div>
