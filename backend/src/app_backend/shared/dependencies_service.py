...
from app_backend.features.application.application_service import \
    ApplicationService
# --- Services (Inside Features - Vertical Slice) ---
...
def get_application_service(
    ...
    application_log_repo: ApplicationLogRepository = Depends(
        get_application_log_repository
    ),
    student_repo: StudentRepository = Depends(get_student_repository),
    placement_repo: PlacementRepository = Depends(get_placement_repository),
) -> ApplicationService:
    return ApplicationService(
        application_repo, application_log_repo, student_repo, placement_repo
    )
