...
class Application:
    ...
    def withdraw(self):
        ...
        if self.status in [ApplicationStatus.REJECTED.value, ApplicationStatus.WITHDRAWN.value]:
    ...
    def move_to_interview(self):
        ...
        if self.status not in [ApplicationStatus.APPLIED.value, ApplicationStatus.SCREENING.value]:
    ...
    def offer(self):
        ...
        if self.status not in [ApplicationStatus.SCREENING.value, ApplicationStatus.INTERVIEW.value]:
    ...
    def reject(self):
        ...
        if self.status in [ApplicationStatus.ACCEPTED.value, ApplicationStatus.REJECTED.value, ApplicationStatus.WITHDRAWN.value]:
